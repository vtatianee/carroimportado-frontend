...
export default function CadastroPecasClient() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const res = await fetch("/api/peca-cadastro", {
        method: "POST",
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
        ...
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-1">
            ...
            <Link href="/pecas" className="text-sm text-blue-600 font-semibold px-3 py-1.5 rounded-lg bg-blue-50 hidden sm:block">
              Peças
            </Link>
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-10">
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-6">
          <Link href="/pecas" className="hover:text-blue-600 transition-colors">Peças</Link>
          <span>›</span>
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Miami Classic Parts"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Ex: Motor e transmissão, Peças raras / clássicos, Importação"
                  className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  placeholder="Conte mais sobre o fornecedor, tipos de peças, marcas atendidas, experiência com exportação ao Brasil, etc."
